...
class TD3Agent(torch.nn.Module):
    ...
    def learn(self, samples):
        ...
        if len(self.buffer) > C.batch_size:
            ...
            # Gradient clipping
            gradients["critic"] = torch.nn.utils.clip_grad_norm_(self.critic.parameters(), max_norm=1.0)
            ...
            if self.total_it % C.policy_freq == 0:
                ...
                # Gradient clipping
                gradients["actor"] = torch.nn.utils.clip_grad_norm_(self.actor.parameters(), max_norm=1.0)
